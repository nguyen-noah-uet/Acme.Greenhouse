    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(GreenhouseConsts.DbTablePrefix + "YourEntities", GreenhouseConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
        builder.Entity<Node>().HasMany(e => e.Devices).WithOne(e => e.Node).HasForeignKey(e => e.NodeId).HasPrincipalKey(e => e.Id);
        builder.Entity<Node>().HasMany(e => e.Sensors).WithOne(e => e.Node).HasForeignKey(e => e.NodeId).HasPrincipalKey(e => e.Id);
