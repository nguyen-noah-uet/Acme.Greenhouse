...
namespace Acme.Greenhouse.Migrations
{
    ...
    [Migration("20240429100200_Added_DbLog")]
    partial class Added_DbLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.DbLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.DeviceStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.Node", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.NodeStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.Sensor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.SensorData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.Device", b =>
                {
                    b.HasOne("Acme.Greenhouse.Nodes.Node", "Node")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.DeviceStatus", b =>
                {
                    b.HasOne("Acme.Greenhouse.Nodes.Device", "Device")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.Greenhouse.Nodes.SensorData", b =>
                {
                    b.HasOne("Acme.Greenhouse.Nodes.Sensor", "Sensor")
                        .WithMany()
